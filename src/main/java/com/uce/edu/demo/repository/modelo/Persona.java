...
@NamedNativeQuery(name = "Persona.buscarPorCedulaNative1", query = "SELECT * FROM persona WHERE pers_cedula = :datoCedula ", resultClass= Persona.class)

/*
 * @NamedNativeQueries({@NamedNativeQuery(name = "Persona.buscarPorCedulaNative", query = "SELECT * FROM persona WHERE pers_cedula = :datoCedula "), @NamedNativeQuery(name = "Persona.buscarPorCedulaNative1", query = "SELECT * FROM persona WHERE pers_cedula = :datoCedula ") })
 */
/*
